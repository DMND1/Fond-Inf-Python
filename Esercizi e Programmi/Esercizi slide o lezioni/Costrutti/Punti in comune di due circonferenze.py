...
if distanza_C1C2 >= min(r1,r2):
    if distanza_C1C2 != 0 :                                              # se i due centri non coincidono
    ...
    elif distanza_C1C2 == 0 and r1 != r2 :                               # se i due centri coincidono e i raggi sono diversi
        risultato = "Le due circonferenze non hanno punti in comune"
    elif distanza_C1C2 == 0 and r1 == r2 and r1 != 0:                    # se i due centri coincidono e i raggi (non nulli) anche
        risultato = "Le due circonferenze hanno infiniti punti in comune"
    elif distanza_C1C2 == 0 and r1 == r2 == 0 :                          # se i due centri coincidono e i raggi (nulli) anche
        risultato = "Le due circonferenze (degeneri) hanno un solo punto in comune"
elif distanza_C1C2 > min(r1,r2):
    risultato = "Le due circonferenze (una contenunta nell'altra) non hanno punti in comune"

# Manca da implementare il caso in cui la distanza dei due centri è minore di uno dei due raggi (ossia se la circonferenza è contenuta nell'altra)
